 ...
 * @since 2.10.0
 */
import { parseJSON, stringifyJSON } from './Either';
...
export var parse = function (s) { return parseJSON(s, identity); };
/**
 ...
 */
// tslint:disable-next-line: deprecation
export var stringify = function (a) { return stringifyJSON(a, identity); };
